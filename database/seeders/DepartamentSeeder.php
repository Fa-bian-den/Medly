...
class DepartamentSeeder extends Seeder
{
    ...
    {
        $departamentsWithMunicipalities = [
            'Boaco' => [
                'Boaco',
                'Camoapa',
        ...
        foreach ($departamentsWithMunicipalities as $departamentName => $municipalities) {
            $departament = Departament::firstOrCreate(['name' => $departamentName]);
